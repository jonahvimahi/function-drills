...
let nameGreeting = nameCheck('Jonah')
...
/*
  ...
  Create a variable called `totalFrogs` and set it equal to your function invoked, passing in the amount of gold you are 
  willing to spend.
*/

//CODE HERE

function goldFrogs(amount){
  let cost=3
  let frogs=Math.floor(amount/cost)
  return frogs
}

let totalFrogs=goldFrogs(6)
////////////////// PROBLEM 13 ////////////////////
/*
...
function goldFrogs2(amount){
  let cost=3
  let frogs=Math.floor(amount/cost)
  return frogs
}

let totalFrogs2=goldFrogs2(6)
...
let arrayIsAscending = higher(sampleArray)
